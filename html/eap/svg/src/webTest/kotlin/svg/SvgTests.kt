...
@file:OptIn(
    ...
    org.jetbrains.compose.web.testutils.ComposeWebExperimentalTestsApi::class,
)
...
import kotlinx.browser.dom.svg.SVGTextElement
...
class SvgTests {
    ...
    fun nodeNames() = runTest {
        ...
        assertEquals(
            ...
            nextChild<SVGElement>().outerHTML
        )
    }
    ...
    fun maskTest() = runTest {
        ...
        assertEquals("<svg><mask id=\"myMask\"></mask></svg>", nextChild<SVGElement>().outerHTML)
    }
    ...
    fun descTest() = runTest {
        ...
        assertEquals("<svg><desc id=\"myDesc\">some description</desc></svg>", nextChild<SVGElement>().outerHTML)
    }
    ...
    fun pathTest() = runTest {
        ...
        assertEquals(
            "<svg><path d=\"M 10,30\n" +
                    ...
                    "A 20,20 0,0,1 90,30\n" +
                    "Q 90,60 50,90\n" +
                    "Q 10,60 10,30 z\"></path></svg>", nextChild<SVGElement>().outerHTML
        )
    }
