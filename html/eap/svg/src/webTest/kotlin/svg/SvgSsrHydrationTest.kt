...
class SvgSsrHydrationTest {
    ...
    fun jvmRenderedSvgHydratesAndComposeUpdatesClaimedNodes() = MainScope().promise {
        val root = browserDocument.createElement("div") as HTMLElement
        root.innerHTML = fetchTestResourceText(SVG_SSR_HYDRATION_FIXTURE_URL)
    ...
    fun hydrationRejectsSvgFromAnotherNamespace() {
        ...
        val wrongNamespaceSvg = browserDocument.createElementNS(mathMlNamespace, "svg")
    ...
    fun hydrationComparesSvgTagNamesCaseSensitively() {
        val root = browserDocument.createElement("div") as HTMLElement
        val serverSvg = browserDocument.createElementNS(SVG_NS, "svg")
        val incorrectlyCasedGradient = browserDocument.createElementNS(SVG_NS, "lineargradient")
