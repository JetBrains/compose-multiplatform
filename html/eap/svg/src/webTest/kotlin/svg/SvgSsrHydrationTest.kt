...
@kotlin.js.JsName("document")
private external val document: Document

internal expect suspend fun fetchSvgFixtureText(input: String): String
...
class SvgSsrHydrationTest {
    ...
    fun jvmRenderedSvgHydratesAndComposeUpdatesClaimedNodes() = MainScope().promise {
        val root = document.createElement("div") as HTMLElement
        root.innerHTML = fetchSvgFixtureText(SVG_SSR_HYDRATION_FIXTURE_URL)
