...
interface GridAutoFlow : StylePropertyString {
    companion object {
        inline val Row: GridAutoFlow get() = createGridAutoFlow("row")
        inline val Column: GridAutoFlow get() = createGridAutoFlow("column")
        inline val Dense: GridAutoFlow get() = createGridAutoFlow("dense")
        inline val RowDense: GridAutoFlow get() = createGridAutoFlow("row dense")
        inline val ColumnDense: GridAutoFlow get() = createGridAutoFlow("column dense")
    }
}
