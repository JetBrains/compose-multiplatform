...
// Kotlin/JS browser strings are already native JavaScript strings, so direct comparisons are the
// allocation-free implementation of the shared hydration checks.
