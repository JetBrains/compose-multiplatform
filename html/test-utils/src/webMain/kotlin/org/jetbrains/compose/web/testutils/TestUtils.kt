...
@JsName("window")
private external val browserWindow: Window
...
class TestScope : CoroutineScope by MainScope() {
    ...
    suspend fun waitForChanges(elementId: String) {
        waitForChanges(browserDocument.getElementById(elementId) as HTMLElement)
    }
...
val HTMLElement.computedStyle: CSSStyleDeclaration
    get() = browserWindow.getComputedStyle(this)
