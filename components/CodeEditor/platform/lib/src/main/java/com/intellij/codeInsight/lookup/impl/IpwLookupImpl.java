...
public class IpwLookupImpl extends LightweightHint implements LookupEx, Disposable, LookupElementListPresenter {
    private static final Logger LOG = Logger.getInstance(IpwLookupImpl.class);
    ...
    private final CollectionListModel<LookupElement> myElementsList = new CollectionListModel<>();
    ...
    public IpwLookupImpl(Project project, Editor editor, @NotNull LookupArranger arranger) {
        super(new JPanel());
        ...
        // myCellRenderer = new LookupCellRenderer(null, myEditor.getContentComponent());
    ...
    public void finishLookup(final char completionChar) {
        ...
        finishLookup(completionChar, myElementsList.getElementAt(0));
    }
    ...
    public LookupElement getCurrentItem(){
        synchronized (myUiLock) {
            ...
            LookupElement item = myElementsList.getElementAt(0);
    ...
    public LookupElement getCurrentItemOrEmpty() {
        ...
        return myElementsList.getElementAt(0);
    }
    ...
    public boolean isPositionedAboveCaret(){
        // myUi != null && myUi.isPositionedAboveCaret();
        return false;
    }
    ...
    List<LookupElement> getVisibleItems() {
        ...
        var itemsCount = myElementsList.getSize();
