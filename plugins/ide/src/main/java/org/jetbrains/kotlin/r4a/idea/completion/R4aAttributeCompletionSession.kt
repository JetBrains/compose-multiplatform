...
class R4aAttributeCompletionSession(
    ...
    private val nullableKtxCall =
        bindingContext.get(R4AWritableSlices.RESOLVED_KTX_CALL, elementExpr)
    ...
    private val ktxCallResolvedCalls by lazy {
        val failedCandidates = bindingContext.get(R4AWritableSlices.FAILED_CANDIDATES, elementExpr)
            ?: emptyList()
