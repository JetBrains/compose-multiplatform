...
abstract class BaseR4aCompletionSession(
    ...
    protected val r4aComponentDescriptor =
        module.findClassAcrossModuleDependencies(
            ClassId.topLevel(R4aUtils.r4aFqName("Component"))
        )
    ...
    protected fun Annotated.hasChildrenAnnotation() =
        annotations.hasAnnotation(r4aChildrenAnnotationFqName)
    protected fun Annotated.hasComposableAnnotation() =
        annotations.hasAnnotation(r4aComposableAnnotationFqName)
