...
class R4aAddImportAction(
    ...
    fun showHint(): Boolean {
        ...
        HintManager.getInstance()
            .showQuestionHint(editor, hintText, element.textOffset, element.textRange!!.endOffset, this)

        return true
    }

    private fun getVariantSelectionPopup(): BaseListPopupStep<ImportVariant> {
        return object : BaseListPopupStep<ImportVariant>(R4aBundle.message("imports.chooser.title"), variants) {
            override fun isAutoSelectionEnabled() = false

            override fun isSpeedSearchEnabled() = true

            override fun onChosen(selectedValue: ImportVariant?, finalChoice: Boolean): PopupStep<String>? {
    ...
    private fun addImport(variant: ImportVariant) {
        ...
        }, R4aBundle.message("add.import"), null)
    }
}