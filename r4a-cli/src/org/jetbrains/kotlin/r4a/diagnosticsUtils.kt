...
fun <E : PsiElement> DiagnosticFactory0<E>.report(context: ExpressionTypingContext, elements: Collection<E>) {
    elements.forEach {
...
fun <E : PsiElement, T1> DiagnosticFactory1<E, T1>.report(context: ExpressionTypingContext, elements: Collection<E>, value1: T1) {
    elements.forEach {
        context.trace.reportFromPlugin(
            on(it, value1),
            R4ADefaultErrorMessages
