...
class IrKtxAttribute(
    ...
    override fun <R, D> accept(visitor: IrElementVisitor<R, D>, data: D): R = visitor.visitKtxStatement(this, data)
    override fun <D> acceptChildren(visitor: IrElementVisitor<Unit, D>, data: D) = value.accept(visitor, data)
