...
class R4aObservePatcher(val context: JvmBackendContext) :
    ...
    private val typeTranslator = TypeTranslator(context.ir.symbols.externalSymbolTable, context.state.languageVersionSettings, context.builtIns).apply {
    ...
    override fun visitFunction(declaration: IrFunction): IrStatement {
        ...
        val observeFunctionDescriptor = module
            ...
            .memberScope
            .getContributedFunctions(Name.identifier("Observe"), NoLookupLocation.FROM_BACKEND)
            .single()
        ...
        return declaration.apply {
            body = irBuilder.irBlockBody {
                ...
                +fn
                +irCall(observeFunctionSymbol, observeFunctionDescriptor, context.irBuiltIns.unitType).also {
                    it.putValueArgument(
