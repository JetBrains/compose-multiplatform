...
fun generateComponentCompanionObject(context: GeneratorContext, componentMetadata: ComponentMetadata, component: IrClass): IrClass {
    val companion = context.symbolTable.declareClass(-1, -1, IrDeclarationOrigin.DEFINED, component.descriptor.companionObjectDescriptor!!)
