 ...
 */
class ComponentMetadata(val descriptor: ClassDescriptor) { // TODO(lmr): ClassDescriptor won't handle SFCs. Consider how to refactor.
    ...
    companion object {
        ...
        fun isR4AComponent(descriptor: DeclarationDescriptor): Boolean {
            ...
            val baseComponentDescriptor =
                descriptor.module.findClassAcrossModuleDependencies(ClassId.topLevel(FqName(R4aUtils.generateR4APackageName() + ".Component")))
                    ?: return false
