...
class KtxCallResolver(
    ...
    private fun resolveAllSetAttributes(
        ...
        if (children != null) {
            ...
            if (resolvedCall != null) {
                ...
                attributes[attrName]?.let {
                    if (attributesUsedInCall.contains(attrName) && attributesUsedInCall.contains(CHILDREN_KEY)) {
        ...
        if (!type.isUnit()) {
            ...
            val requiredAttributes = cls.unsubstitutedMemberScope
                ...
                .filter {
                    it.isLateInit && it.visibility.isVisibleOutside() && !Visibilities.isPrivate(it.visibility)
                }
    ...
    private fun resolveAttributeAsProperty(
        ...
        val resolvedCall = OverloadResolutionResultsUtil.getResultingCall(results, contextToUse) ?: return null
