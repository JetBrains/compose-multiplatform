...
#### Web (k/js)
- Decoys generation was disabled. It means the libraries which depend on earlier Compose Multiplatform version are not compatible with 1.6.0 anymore. Projects which apply  Compose Compiler plugin manually need to remove this argument: `plugin:androidx.compose.compiler.plugins.kotlin:generateDecoys=true` 
