...
In this guide, we'll show you how to create self-sufficient native distributions (installers/packages) for all supported systems. 
...
simplifies packaging of applications into native distributions and running an application locally.
