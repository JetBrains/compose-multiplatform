...
You can create the project by [downloading the template here](https://github.com/JetBrains/compose-multiplatform-web-template) or using the Project Wizard in IDEA:
