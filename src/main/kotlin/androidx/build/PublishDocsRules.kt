...
val RELEASE_RULE = docsRules("public", false) {
    ...
    prebuilts(LibraryGroups.BENCHMARK, "1.0.0-alpha05")
    ...
    prebuilts(LibraryGroups.FRAGMENT, "1.2.0-alpha03")
    ...
    prebuilts(LibraryGroups.LIFECYCLE, "lifecycle-viewmodel-savedstate", "1.0.0-alpha04")
    prebuilts(LibraryGroups.LIFECYCLE, "2.2.0-alpha04")
    ...
    prebuilts(LibraryGroups.NAVIGATION, "2.2.0-alpha02")
