...
val RELEASE_RULE = docsRules("public", false) {
    ...
    prebuilts(LibraryGroups.CAMERA, "camera-view", "1.0.0-alpha15")
    prebuilts(LibraryGroups.CAMERA, "camera-extensions", "1.0.0-alpha15")
    ...
    prebuilts(LibraryGroups.CORE, "core", "1.5.0-alpha02")
    ...
    prebuilts(LibraryGroups.CORE, "core-ktx", "1.5.0-alpha02")
    ...
    prebuilts(LibraryGroups.EXIFINTERFACE, "1.3.0-rc01")
    ...
    prebuilts(LibraryGroups.MEDIA, "media", "1.2.0-rc01")
    ...
    prebuilts(LibraryGroups.MEDIAROUTER, "1.2.0-beta01")
...
//    prebuilts(LibraryGroups.SLICE.group, "slice-test", "1.0.0")
    ...
    prebuilts(LibraryGroups.STARTUP, "1.0.0-alpha03")
    ...
    prebuilts(LibraryGroups.WEBKIT, "1.3.0")
