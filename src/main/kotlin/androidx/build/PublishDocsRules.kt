...
val RELEASE_RULE = docsRules("public", false) {
    ...
    prebuilts(LibraryGroups.APPCOMPAT, "1.2.0-alpha01")
    ...
    prebuilts(LibraryGroups.BROWSER, "1.2.0-rc01")
    ...
    prebuilts(LibraryGroups.CAMERA, "camera-lifecycle", "1.0.0-alpha01")
    ...
    prebuilts(LibraryGroups.EXIFINTERFACE, "1.1.0")
    ...
    prebuilts(LibraryGroups.FRAGMENT, "1.2.0-rc03")
    ...
    prebuilts(LibraryGroups.LIFECYCLE, "lifecycle-viewmodel-savedstate", "1.0.0-rc03")
    ...
    prebuilts(LibraryGroups.NAVIGATION, "2.2.0-rc03")
    ...
    prebuilts(LibraryGroups.RECYCLERVIEW, "recyclerview-selection", "1.1.0-beta01")
