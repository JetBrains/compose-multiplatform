...
val RELEASE_RULE = docsRules("public", false) {
    prebuilts(LibraryGroups.ACTIVITY, "1.2.0-alpha01")
    ...
    prebuilts(LibraryGroups.CORE, "core", "1.3.0-alpha02")
    prebuilts(LibraryGroups.CORE, "core-ktx", "1.3.0-alpha02")
    prebuilts(LibraryGroups.CORE, "core-role", "1.0.0-beta01")
    prebuilts(LibraryGroups.CURSORADAPTER, "1.0.0")
    prebuilts(LibraryGroups.CUSTOMVIEW, "1.1.0-alpha02")
    prebuilts(LibraryGroups.DOCUMENTFILE, "1.0.0")
    prebuilts(LibraryGroups.DRAWERLAYOUT, "1.1.0-alpha04")
    ...
    prebuilts(LibraryGroups.FRAGMENT, "1.3.0-alpha01")
    ...
    prebuilts(LibraryGroups.MEDIA, "media", "1.2.0-alpha01")
    ...
    prebuilts(LibraryGroups.NAVIGATION, "2.3.0-alpha03")
    ...
    prebuilts(LibraryGroups.SHARETARGET, "1.0.0-rc01")
...
//    prebuilts(LibraryGroups.SLICE.group, "slice-test", "1.0.0")
    ...
    prebuilts(LibraryGroups.SWIPEREFRESHLAYOUT, "1.1.0-beta01")
    ...
    prebuilts(LibraryGroups.WEBKIT, "1.2.0-rc01")
    ...
    prebuilts(LibraryGroups.WORK, "2.4.0-alpha01")
    default(Ignore)
}
