...
val RELEASE_RULE = docsRules("public", false) {
    ...
    prebuilts(LibraryGroups.APPCOMPAT, "1.2.0-alpha02")
    ...
    prebuilts(LibraryGroups.CORE, "core", "1.3.0-alpha01")
    prebuilts(LibraryGroups.CORE, "core-ktx", "1.3.0-alpha01")
    ...
    prebuilts(LibraryGroups.EXIFINTERFACE, "1.2.0-beta01")
    ...
    prebuilts(LibraryGroups.FRAGMENT, "1.2.1")
    ...
    prebuilts(LibraryGroups.MEDIA2, "media2-widget", "1.0.2")
    prebuilts(LibraryGroups.MEDIA2, "1.0.2")
    ...
    prebuilts(LibraryGroups.NAVIGATION, "2.3.0-alpha01")
