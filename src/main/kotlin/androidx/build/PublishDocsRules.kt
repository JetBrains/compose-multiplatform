...
val RELEASE_RULE = docsRules("public", false) {
    prebuilts(LibraryGroups.ACTIVITY, "1.1.0-alpha03")
    prebuilts(LibraryGroups.ADS, "1.0.0-alpha02")
    prebuilts(LibraryGroups.ANNOTATION, "annotation", "1.1.0")
    prebuilts(LibraryGroups.ANNOTATION, "annotation-experimental", "1.0.0-alpha01")
    prebuilts(LibraryGroups.ANNOTATION, "annotation-experimental-lint", "1.0.0-alpha01")
    ...
    prebuilts(LibraryGroups.BENCHMARK, "1.0.0-alpha06")
    prebuilts(LibraryGroups.BIOMETRIC, "biometric", "1.0.0-beta02")
    ...
    prebuilts(LibraryGroups.CAMERA, "camera-view", "1.0.0-alpha02")
    prebuilts(LibraryGroups.CAMERA, "camera-extensions", "1.0.0-alpha02")
    prebuilts(LibraryGroups.CAMERA, "1.0.0-alpha05")
    ...
    prebuilts(LibraryGroups.CORE, "core-ktx", "1.2.0-alpha04")
    ...
    prebuilts(LibraryGroups.FRAGMENT, "1.2.0-alpha04")
    ...
    prebuilts(LibraryGroups.MEDIA2, "media2-widget", "1.0.0")
    prebuilts(LibraryGroups.MEDIA2, "1.0.0")
    ...
    prebuilts(LibraryGroups.NAVIGATION, "2.2.0-alpha03")
    ...
    prebuilts(LibraryGroups.RECYCLERVIEW, "recyclerview", "1.1.0-beta04")
...
//    prebuilts(LibraryGroups.SLICE.group, "slice-test", "1.0.0")
    ...
    prebuilts(LibraryGroups.TRANSITION, "1.2.0-rc01")
    ...
    prebuilts(LibraryGroups.VIEWPAGER2, "1.0.0-beta04")
    prebuilts(LibraryGroups.WEAR, "1.0.0")
            .addStubs("wear/wear_stubs/com.google.android.wearable-stubs.jar")
    prebuilts(LibraryGroups.WEBKIT, "1.1.0-beta01")
