...
val RELEASE_RULE = docsRules("public", false) {
    ...
    prebuilts(LibraryGroups.CAMERA, "camera-view", "1.0.0-alpha11")
    prebuilts(LibraryGroups.CAMERA, "camera-extensions", "1.0.0-alpha11")
            .addStubs("camera/camera-extensions-stub/camera-extensions-stub.jar")
    prebuilts(LibraryGroups.CAMERA, "1.0.0-beta04")
    ...
    prebuilts(LibraryGroups.SECURITY, "1.1.0-alpha01")
...
//    prebuilts(LibraryGroups.SLICE.group, "slice-test", "1.0.0")
    ...
    prebuilts(LibraryGroups.SLIDINGPANELAYOUT, "1.1.0-rc01")
