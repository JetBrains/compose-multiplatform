...
val RELEASE_RULE = docsRules("public", false) {
    ...
    prebuilts(LibraryGroups.CAMERA, "camera-view", "1.0.0-alpha10")
    prebuilts(LibraryGroups.CAMERA, "camera-extensions", "1.0.0-alpha10")
            .addStubs("camera/camera-extensions-stub/camera-extensions-stub.jar")
    prebuilts(LibraryGroups.CAMERA, "1.0.0-beta03")
    ...
    prebuilts(LibraryGroups.CORE, "core", "1.4.0-alpha01")
    prebuilts(LibraryGroups.CORE, "core-animation", "1.0.0-alpha01")
    prebuilts(LibraryGroups.CORE, "core-animation-testing", "1.0.0-alpha01")
    prebuilts(LibraryGroups.CORE, "core-ktx", "1.4.0-alpha01")
    prebuilts(LibraryGroups.CORE, "core-role", "1.1.0-alpha01")
    ...
    prebuilts(LibraryGroups.DRAWERLAYOUT, "1.1.0-beta01")
    ...
    prebuilts(LibraryGroups.FRAGMENT, "1.3.0-alpha05")
    ...
    prebuilts(LibraryGroups.LIFECYCLE, "2.3.0-alpha03")
    ...
    prebuilts(LibraryGroups.MEDIA, "media", "1.2.0-alpha02")
    ...
    prebuilts(LibraryGroups.NAVIGATION, "2.3.0-beta01")
...
//    prebuilts(LibraryGroups.SLICE.group, "slice-test", "1.0.0")
    ...
    prebuilts(LibraryGroups.SLIDINGPANELAYOUT, "1.1.0-beta01")
