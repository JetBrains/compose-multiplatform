...
val RELEASE_RULE = docsRules("public", false) {
    ...
    prebuilts(LibraryGroups.CAMERA, "camera-view", "1.0.0-alpha09")
    prebuilts(LibraryGroups.CAMERA, "camera-extensions", "1.0.0-alpha09")
            .addStubs("camera/camera-extensions-stub/camera-extensions-stub.jar")
    prebuilts(LibraryGroups.CAMERA, "1.0.0-beta02")
