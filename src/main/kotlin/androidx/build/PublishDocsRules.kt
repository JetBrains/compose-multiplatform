...
val RELEASE_RULE = docsRules("public", false) {
    ...
    prebuilts(LibraryGroups.ACTIVITY, "1.2.0-beta01")
    ...
    prebuilts(LibraryGroups.BROWSER, "1.3.0-beta01")
    ...
    prebuilts(LibraryGroups.Compose.ANIMATION, "1.0.0-alpha06")
    prebuilts(LibraryGroups.Compose.FOUNDATION, "1.0.0-alpha06")
    ignore(LibraryGroups.Compose.MATERIAL.group, "generator")
    prebuilts(LibraryGroups.Compose.MATERIAL, "1.0.0-alpha06")
    // Ignore runtime-rxjava3 until we import the runtime-rxjava3 prebuilt
    ignore(LibraryGroups.Compose.RUNTIME.group, "runtime-rxjava3")
    // Ignore runtime-rxjava3-samples until we import the runtime-rxjava3-sample prebuilt
    ignore(LibraryGroups.Compose.RUNTIME.group, "runtime-rxjava3-samples")
    prebuilts(LibraryGroups.Compose.RUNTIME, "1.0.0-alpha06")
    ignore(LibraryGroups.Compose.UI.group, "ui-test")
    ignore(LibraryGroups.Compose.UI.group, "ui-test-font")
    prebuilts(LibraryGroups.Compose.UI, "1.0.0-alpha06")
    ...
    prebuilts(LibraryGroups.CORE, "core", "1.5.0-alpha04")
    ...
    prebuilts(LibraryGroups.CORE, "core-ktx", "1.5.0-alpha04")
    ...
    prebuilts(LibraryGroups.FRAGMENT, "1.3.0-beta01")
    ...
    prebuilts(LibraryGroups.LIFECYCLE, "2.3.0-beta01")
    ...
    prebuilts(LibraryGroups.MEDIA2, "media2-widget", "1.1.0-rc01")
    prebuilts(LibraryGroups.MEDIA2, "1.1.0-rc01")
    ...
    prebuilts(LibraryGroups.NAVIGATION, "navigation-compose", "1.0.0-alpha01")
    prebuilts(LibraryGroups.NAVIGATION, "navigation-compose-samples", "1.0.0-alpha01")
    prebuilts(LibraryGroups.NAVIGATION, "2.3.1")
    prebuilts(LibraryGroups.PAGING, "paging-compose", "1.0.0-alpha01")
    prebuilts(LibraryGroups.PAGING, "3.0.0-alpha08")
    ...
    prebuilts(LibraryGroups.PRINT, "1.1.0-beta01")
...
//    prebuilts(LibraryGroups.SLICE.group, "slice-test", "1.0.0")
    ...
    prebuilts(LibraryGroups.STARTUP, "1.0.0")
    ...
    ignore(LibraryGroups.Compose.UI.group, "ui-animation-tooling-internal")
    prebuilts(LibraryGroups.Compose.UI, "1.0.0-alpha06")
    ...
    prebuilts(LibraryGroups.WEAR, "wear-complications-data", "1.0.0-alpha01")
    prebuilts(LibraryGroups.WEAR, "wear-complications-provider", "1.0.0-alpha01")
    prebuilts(LibraryGroups.WEAR, "wear-complications-rendering", "1.0.0-alpha01")
    prebuilts(LibraryGroups.WEAR, "wear-watchface", "1.0.0-alpha01")
    prebuilts(LibraryGroups.WEAR, "wear-watchface-complications-rendering", "1.0.0-alpha01")
    prebuilts(LibraryGroups.WEAR, "wear-watchface-data", "1.0.0-alpha01")
    prebuilts(LibraryGroups.WEAR, "wear-watchface-samples", "1.0.0-alpha01")
    prebuilts(LibraryGroups.WEAR, "wear-watchface-style", "1.0.0-alpha01")
    prebuilts(LibraryGroups.WEAR, "wear-input-testing", "1.0.0-beta01")
    prebuilts(LibraryGroups.WEAR, "wear-input", "1.0.0-beta01")
    prebuilts(LibraryGroups.WEAR, "wear", "1.2.0-alpha01")
    ...
    prebuilts(LibraryGroups.WORK, "2.5.0-beta01")
    default(Ignore)
}
