...
object LibraryVersions {
    ...
    val COMPOSE = Version(System.getenv("COMPOSE_CUSTOM_VERSION") ?: "1.0.0-beta01")
    ...
    val WEAR_COMPLICATIONS = Version("1.0.0-alpha07")
    val WEAR_INPUT = Version("1.1.0-alpha02")
    val WEAR_ONGOING = Version("1.0.0-alpha02")
    val WEAR_PHONE_INTERACTIONS = Version("1.0.0-alpha02")
    val WEAR_REMOTE_INTERACTIONS = Version("1.0.0-alpha02")
    val WEAR_TILES = Version("1.0.0-alpha01")
    val WEAR_TILES_DATA = WEAR_TILES
    val WEAR_WATCHFACE = Version("1.0.0-alpha07")
    val WEAR_WATCHFACE_CLIENT = Version("1.0.0-alpha07")
    val WEAR_WATCHFACE_DATA = Version("1.0.0-alpha07")
    val WEAR_WATCHFACE_EDITOR = Version("1.0.0-alpha07")
    val WEAR_WATCHFACE_STYLE = Version("1.0.0-alpha07")
