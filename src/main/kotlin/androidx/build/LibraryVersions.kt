...
object LibraryVersions {
    val ACTIVITY = Version("1.2.0-alpha04")
    ...
    val CAMERA = Version("1.0.0-beta03")
    val CAMERA_EXTENSIONS = Version("1.0.0-alpha10")
    val CAMERA_VIEW = Version("1.0.0-alpha010")
    ...
    val DRAWERLAYOUT = Version("1.1.0-beta01")
    ...
    val FRAGMENT = Version("1.3.0-alpha04")
    ...
    val SECURITY = Version("1.0.0-rc01")
    ...
    val SLIDINGPANELAYOUT = Version("1.1.0-beta01")
