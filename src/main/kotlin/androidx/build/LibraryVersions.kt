...
object LibraryVersions {
    ...
    val CORE = Version("1.1.0-alpha07")
    ...
    val LIFECYCLE = Version("2.1.0-beta02")
    ...
    val MEDIA = Version("1.1.0-alpha06")
    val MEDIA2_COMMON = Version("1.0.0-alpha06")
    val MEDIA2_PLAYER = Version("1.0.0-alpha06")
    val MEDIA2_SESSION = Version("1.0.0-alpha06")
    val MEDIA2_EXOPLAYER = Version("1.0.0-alpha02")
    val MEDIA2_WIDGET = Version("1.0.0-alpha07")
    val MEDIAROUTER = Version("1.1.0-alpha05")
