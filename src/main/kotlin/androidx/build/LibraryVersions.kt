...
object LibraryVersions {
    ...
    val COMPOSE = Version(System.getenv("COMPOSE_CUSTOM_VERSION") ?: "1.0.0-beta06")
    val COORDINATORLAYOUT = Version("1.2.0-alpha01")
    val CORE = Version("1.6.0-alpha03")
    ...
    val CORE_GOOGLE_SHORTCUTS = Version("1.0.0-alpha03")
    ...
    val SLIDINGPANELAYOUT = Version("1.2.0-alpha02")
    val STARTUP = Version("1.1.0-alpha03")
    ...
    val WEAR_TILES = Version("1.0.0-alpha04")
    val WEAR_WATCHFACE = Version("1.0.0-alpha13")
    val WEAR_WATCHFACE_CLIENT = Version("1.0.0-alpha13")
    val WEAR_WATCHFACE_CLIENT_GUAVA = WEAR_WATCHFACE_CLIENT
    val WEAR_WATCHFACE_COMPLICATIONS_RENDERING = Version("1.0.0-alpha13")
    val WEAR_WATCHFACE_DATA = Version("1.0.0-alpha13")
    val WEAR_WATCHFACE_EDITOR = Version("1.0.0-alpha13")
    val WEAR_WATCHFACE_EDITOR_GUAVA = WEAR_WATCHFACE_EDITOR
    val WEAR_WATCHFACE_STYLE = Version("1.0.0-alpha13")
