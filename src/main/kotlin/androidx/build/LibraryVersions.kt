...
object LibraryVersions {
    ...
    val CAMERA = Version("1.0.0-alpha09")
    val CAMERA_EXTENSIONS = Version("1.0.0-alpha06")
    val CAMERA_LIFECYCLE = Version("1.0.0-alpha03")
    val CAMERA_VIEW = Version("1.0.0-alpha06")
    ...
    val RECYCLERVIEW_SELECTION = Version("1.1.0-beta01")
