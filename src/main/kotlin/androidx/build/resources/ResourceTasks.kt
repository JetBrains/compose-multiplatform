    ...
    fun Project.configureAndroidProjectForResourceTasks(
        ...
        afterEvaluate { project ->
            ...
            library.defaultPublishVariant { variant ->
                ...
                val builtApiFile = project.tasks
                    .named("package${variant.name.capitalize(Locale.US)}Resources")
                    .flatMap { (it as com.android.build.gradle.tasks.MergeResources).publicFile }
                setupProject(project, builtApiFile)
            }
        }
    }
    ...
    private fun setupProject(
        ...
        val checkResourceApiRelease = project.getRequiredCompatibilityApiLocation()?.let {
            ...
            project.tasks.register(
                ...
                // Sets up an implicit dependency on packageReleaseResources task.
