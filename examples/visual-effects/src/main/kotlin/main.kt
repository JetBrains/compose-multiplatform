package org.jetbrains.compose.demo.words
...
fun FallingSnow() {
    BoxWithConstraints(Modifier.fillMaxSize()) {
        repeat(50) {
            val size = remember { 20.dp + 10.dp * random().toFloat() }
            val alpha = remember { 0.10f + 0.15f * random().toFloat() }
            ...
            val initialT = remember { random().toFloat() }
