...
): AndroidComposeTestRule<T> = androidx.compose.ui.test.createAndroidComposeRule()
...
fun <T : ComponentActivity> createAndroidComposeRule(
    ...
    disableTransitions: Boolean = false,
    disableBlinkingCursor: Boolean = true
): AndroidComposeTestRule<T> = androidx.compose.ui.test.createAndroidComposeRule(activityClass)
