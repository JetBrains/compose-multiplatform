...
class ElementsTests {
    ...
    fun keyChangesTheOrderButKeepsSameInstances() = runTest {
        ...
        (root.children[0]!! as HasFakeId).fakeid = "0"
        (root.children[1]!! as HasFakeId).fakeid = "1"
        (root.children[2]!! as HasFakeId).fakeid = "2"
        ...
        assertEquals("0", (root.children[2]!! as HasFakeId).fakeid)
        assertEquals("1", (root.children[1]!! as HasFakeId).fakeid)
        assertEquals("2", (root.children[0]!! as HasFakeId).fakeid)
    }
}

internal external interface HasFakeId {
    var fakeid: String?
}
