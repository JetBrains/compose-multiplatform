...
@RequiresOptIn(
    message = "This is an experimental API for Easing curves. It may change in the future."
)
@Target(
...
annotation class ExperimentalEasingApi
...
/**
 *  ![EaseOutCirc Curve](https://developer.android.com/images/reference/androidx/compose/animation-core/ease_out-circ.gif)
 */
@Suppress("OPT_IN_MARKER_ON_WRONG_TARGET")
@get:ExperimentalEasingApi
