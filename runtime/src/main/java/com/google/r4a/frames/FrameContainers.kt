...
class ModelList<T> : MutableList<T>, Framed {
    ...
    @Suppress("UNCHECKED_CAST") private val readable: ArrayContainer<T> get() =
        _readable(myFirst, this) as ArrayContainer<T>
    @Suppress("UNCHECKED_CAST") private val writable: ArrayContainer<T> get() =
        _writable(myFirst, this) as ArrayContainer<T>
