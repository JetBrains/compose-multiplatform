...
internal value class Strings private constructor(
    ...
    companion object {
        ...
        val DateRangeInputInvalidRangeInput = Strings(38)
        val TooltipLongPressLabel = Strings(39)
        val TimePickerAM = Strings(40)
        val TimePickerPM = Strings(41)
        val TimePickerPeriodToggle = Strings(42)
        val TimePickerHourSelection = Strings(43)
        val TimePickerMinuteSelection = Strings(44)
        val TimePickerHourSuffix = Strings(45)
        val TimePicker24HourSuffix = Strings(46)
        val TimePickerMinuteSuffix = Strings(47)
    }
}
