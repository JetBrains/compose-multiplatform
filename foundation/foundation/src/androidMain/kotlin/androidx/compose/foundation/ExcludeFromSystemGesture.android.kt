...
private class ExcludeFromSystemGestureModifier(
    ...
    fun replaceRect(newRect: AndroidRect?) {
        val rects = mutableVectorOf<AndroidRect>()
    ...
    private fun calcBounds(layoutCoordinates: LayoutCoordinates, rect: Rect): AndroidRect {
