...
val mainComponents =
    listOf(
        ComposeComponent(":compose:animation:animation", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:animation:animation-core", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:animation:animation-graphics", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:foundation:foundation", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:foundation:foundation-layout", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:material:material", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:material3:material3", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:material:material-icons-core", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:material:material-ripple", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:runtime:runtime"),
        ComposeComponent(":compose:runtime:runtime-saveable", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:ui:ui", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:ui:ui-geometry", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:ui:ui-graphics", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ...
        ComposeComponent(":compose:ui:ui-text", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ...
        ComposeComponent(":compose:ui:ui-unit", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:ui:ui-util", supportedPlatforms = ComposePlatforms.JVM_BASED),
    )
