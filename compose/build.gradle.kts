...
val mainComponents =
    listOf(
        ...
        ComposeComponent(":compose:material:material-icons-extended-filled", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:material:material-icons-extended-outlined", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:material:material-icons-extended-rounded", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:material:material-icons-extended-sharp", supportedPlatforms = ComposePlatforms.JVM_BASED),
        ComposeComponent(":compose:material:material-icons-extended-twotone", supportedPlatforms = ComposePlatforms.JVM_BASED),
